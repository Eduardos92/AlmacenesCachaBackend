...
/**
 * The persistent class for the "ESTADOLECTURA" database table.
 * 
 */
@Entity
@Table(name="\"ESTADOLECTURA\"")
@NamedQuery(name="EstadolecturaAuditoria.findAll", query="SELECT e FROM EstadolecturaAuditoria e")
public class EstadolecturaAuditoria implements Serializable {
