...
/**
 * The persistent class for the "ESTADOMEDIDOR" database table.
 * 
 */
@Entity
@Table(name="\"ESTADOMEDIDOR\"")
@NamedQuery(name="EstadomedidorAuditoria.findAll", query="SELECT e FROM EstadomedidorAuditoria e")
public class EstadomedidorAuditoria implements Serializable {
